...
# ------------------------------------------------------------------------------
PROMPT_01_DOLOR = """{
  "role": "Eres un Analista de Diagnóstico de Negocios. Tu única función es descomponer una idea de negocio en sus componentes fácticos y diagnosticar el problema raíz con precisión clínica. Tu lenguaje debe ser 100% objetivo y descriptivo, evitando juicios de valor y jerga de negocios.",
  "context": {
    "user_input": {
  ...
  "output_format": {
    "type": "json",
    "description": "El output debe ser un único objeto JSON que contenga el diagnóstico completo del dolor del cliente.",
    "structure": {
      "diagnostico_dolor": {
        "clasificacion": {
          "tipo": "Analgésico",
  ...
  "rules": [
    "Regla 1: El output debe ser exclusivamente un objeto JSON válido y bien formado.",
...
PROMPT_02_PROPOSITO = """{
  ...
  "output_format": {
    "type": "json",
    "description": "El output debe ser un único objeto JSON, sin texto introductorio, que contenga el análisis completo del propósito del negocio.",
    "structure": {
      "analisis_proposito": {
...
PROMPT_03_MISION = """{
  ...
  "output_format": {
    "type": "json",
    "description": "El output debe ser un único objeto JSON que estructure los componentes y la declaración de misión final.",
    "structure": {
      "definicion_mision": {
...
PROMPT_04_VISION = """{
  ...
  "output_format": {
    "type": "json",
    "description": "El output debe ser un único objeto JSON que contenga el análisis y la declaración de visión.",
    "structure": {
      "definicion_vision": {
...
PROMPT_05_VALORES = """{
  ...
  "output_format": {
    "type": "json",
    "description": "El output debe ser un único objeto JSON que estructure el proceso de selección y la definición de los valores fundamentales.",
    "structure": {
...
PROMPT_06_CLIENTE_P1 = """{
  ...
  "output_format": {
    "type": "json",
    "description": "El output debe ser un único objeto JSON, sin texto introductorio. La estructura debe seguir este formato exacto.",
    "structure": {
  ...
  "rules": [
    "Regla 1: El output debe ser exclusivamente un objeto JSON válido.",
...
PROMPT_07_CLIENTE_P2 = """{
  ...
  "output_format": {
    "type": "json",
    "description": "El output debe ser un único objeto JSON, sin texto introductorio. La estructura debe ser rigurosa para su correcto procesamiento automático.",
    "structure": {
...
""" # OJO: Corregí el nombre de tu archivo
PROMPT_08_PROPUESTA_VALOR = """{
  ...
  "output_format": {
    "type": "json",
    "description": "El output debe ser un único objeto JSON que contenga la propuesta de valor detallada para el Avatar de cliente ideal.",
    "structure": {
...
PROMPT_09_FUENTES_INGRESOS = """{
  ...
  "output_format": {
    "type": "json",
    "description": "El output debe ser un único objeto JSON, sin texto introductorio, que detalle el modelo de ingresos principal y los dos secundarios.",
    "structure": {
...
PROMPT_10_INNOVACION = """{
  ...
  "output_format": {
    "type": "json",
    "description": "El output debe ser un único objeto JSON que contenga una introducción estática, el diagnóstico completo, la educación y una hipótesis de innovación concreta y accionable.",
    "structure": {
      "estrategia_innovacion_inicial": {
        ...
        "hipotesis_guiada": {
          ...
          "hipotesis_recomendada": "Nuestra hipótesis es que si lanzamos un 'Foro de Soporte Comunitario', entonces reduciremos los tickets de soporte para dudas comunes en un 30% en 6 meses y aumentaremos la retención de clientes, lo que nos permitirá reforzar nuestra promesa de 'tranquilidad' y construir una comunidad leal.",
...
PROMPT_11_CANALES = """{
  ...
  "output_format": {
    "type": "json",
    "description": "El output debe ser un único objeto JSON, sin texto introductorio, que estructure claramente el mix de canales y el mapa del viaje del cliente.",
    "structure": {
...
PROMPT_12_RELACIONES_CLIENTES = """{
  ...
  "output_format": {
    "type": "json",
    "description": "El output debe ser un único objeto JSON que detalle la estrategia de relación y el sistema para gestionarla.",
    "structure": {
...
PROMPT_13_ALIANZAS_CLAVE = """{
  ...
  "output_format": {
    "type": "json",
    "description": "El output debe ser un único objeto JSON que contenga el análisis, las ideas, la recomendación y el plan general.",
    "structure": {
...
PROMPT_14_ACTIVIDADES_CLAVE = """{
  ...
  "output_format": {
    "type": "json",
    "description": "El output debe ser un único objeto JSON que contenga un array de los tres procesos operativos clave.",
    "structure": {
  ...
  "rules": [
    "Regla 1: El output debe ser exclusivamente un objeto JSON válido.",
    "Regla 2: El resultado debe contener exactamente tres objetos, uno para cada macro-proceso.",
...
PROMPT_16_ESTRUCTURA_COSTES = """{
  ...
  "output_format": {
    "type": "json",
    "description": "El output debe ser un único objeto JSON, sin texto introductorio, que contenga el análisis de ambas estrategias de costes.",
    "structure": {
    ...
    "stakeholders_primarios": [
      {
        ...
        "analisis_valor_compartido": {
          "valor_entregado_por_negocio": "Acceso a un descubrimiento curado de cafés únicos, la conveniencia de la entrega a domicilio, la conexión con las historias auténticas de los productores y un producto de alta calidad consistente.",
          "valor_aportado_al_negocio": "Ingresos recurrentes, validación de la propuesta de valor, retroalimentación para la mejora de la curación y la experiencia, y marketing orgánico a través de recomendaciones."
        },
        "analisis_conflicto_potencial": {
          "riesgo_causado_por_negocio": "Inconsistencia en la calidad del café, retrasos en los envíos, mala experiencia de cliente (unboxing, soporte), precios que no se perciben justificados por el valor.",
          "riesgo_afrontado_por_negocio": "Alta tasa de cancelación de suscripciones (churn), malas reseñas públicas, cambio a competidores, publicidad negativa de boca en boca."
        }
      },
      {
        "stakeholder": "Pequeños Productores de Café (Proveedores Clave)",
        "justificacion_relevancia": "Son la fuente del producto y de la autenticidad que diferencia al negocio. Sin su colaboración y sus micro-lotes de calidad, la propuesta de valor se desmorona.",
        "analisis_valor_compartido": {
          "valor_entregado_por_negocio": "Un nuevo canal de venta directo al consumidor, un precio justo y a menudo superior al del mercado local, una plataforma para contar su historia y dar a conocer su finca, y una demanda potencialmente estable.",
          "valor_aportado_al_negocio": "El producto principal (café de especialidad), la exclusividad de sus lotes, la autenticidad y el contenido narrativo que son el núcleo del marketing, y la credibilidad en el mundo del café."
        },
        "analisis_conflicto_potencial": {
          "riesgo_causado_por_negocio": "Pagos retrasados o injustos, tergiversación de su historia o prácticas, exigencia de volúmenes o condiciones insostenibles, falta de comunicación o compromiso a largo plazo.",
          "riesgo_afrontado_por_negocio": "Incapacidad para entregar la calidad o cantidad prometida (por plagas, clima, etc.), venta de sus mejores lotes a otros compradores, aumento de precios, prácticas no éticas que dañen la reputación de la marca."
        }
      },
      {
        "stakeholder": "Equipo Fundador / Colaboradores Clave",
        "justificacion_relevancia": "Son el motor intelectual y operativo que ejecuta la visión. Su conocimiento en cata, curación, marketing y logística es indispensable para que el negocio funcione.",
        "analisis_valor_compartido": {
          "valor_entregado_por_negocio": "Realización profesional y creativa, compensación económica, la oportunidad de construir un negocio con propósito y conectado con la cultura del país.",
          "valor_aportado_al_negocio": "La visión estratégica, la experiencia en café, la ejecución de todas las actividades clave (desde la compra hasta el marketing), y la encarnación de la cultura de la empresa."
        },
        "analisis_conflicto_potencial": {
          "riesgo_causado_por_negocio": "Carga de trabajo excesiva (burnout), falta de una visión clara y compartida, conflictos internos, falta de reconocimiento o una compensación inadecuada.",
          "riesgo_afrontado_por_negocio": "Bajo rendimiento por desmotivación, renuncia de talento clave con conocimiento crítico, incapacidad para escalar por falta de capacidad, decisiones estratégicas erróneas."
        }
      }
    ],
    "stakeholders_secundarios": [
      {
        "stakeholder": "Competencia (Otras suscripciones, marcas de café de especialidad)",
        "justificacion_relevancia": "Definen las expectativas del mercado en cuanto a precio, calidad y experiencia. Sus acciones pueden impactar directamente la capacidad del negocio para adquirir y retener clientes.",
        "analisis_valor_compartido": {
          "valor_entregado_por_negocio": "Al innovar en la narrativa y la experiencia, eleva el estándar del mercado, forzándolos a mejorar. Ayuda a educar a un público más amplio sobre el valor del café de especialidad mexicano.",
          "valor_aportado_al_negocio": "Proporcionan un punto de referencia (benchmarking) para la propia oferta, validan que existe un mercado para el producto, y sus debilidades pueden ser explotadas como oportunidades de diferenciación."
        },
        "analisis_conflicto_potencial": {
          "riesgo_causado_por_negocio": "Iniciar una guerra de precios, capturar cuota de mercado con ofertas agresivas, comparar explícitamente y de forma negativa sus productos.",
          "riesgo_afrontado_por_negocio": "Copiar el modelo de negocio (curación por regiones), asegurar contratos de exclusividad con productores clave, ofrecer una mejor experiencia o un precio más bajo por una calidad similar."
        }
      },
      {
        "stakeholder": "Comunidad de Entusiastas del Café (Online y Offline)",
        "justificacion_relevancia": "Actúan como un poderoso amplificador de la reputación de la marca. Su opinión puede construir o destruir la credibilidad del negocio, especialmente en un nicho tan apasionado.",
        "analisis_valor_compartido": {
          "valor_entregado_por_negocio": "Nuevos y emocionantes cafés para probar y discutir, contenido educativo y narrativo de alta calidad, una marca que se alinea con sus valores de autenticidad y apoyo al productor.",
          "valor_aportado_al_negocio": "Validación y credibilidad por parte de expertos, marketing de boca en boca orgánico y muy efectivo, una fuente de retroalimentación honesta, y un semillero de clientes tempranos (early adopters)."
        },
        "analisis_conflicto_potencial": {
          "riesgo_causado_por_negocio": "Marketing engañoso, no cumplir con la calidad prometida, mostrar falta de conocimiento o respeto por la cultura del café, no participar auténticamente en las conversaciones de la comunidad.",
          "riesgo_afrontado_por_negocio": "Críticas públicas y masivas en foros y redes sociales, ser etiquetado como 'falso' o 'pretencioso', pérdida total de credibilidad en el nicho."
        }
      },
      {
        "stakeholder": "Entidades Gubernamentales / Reguladoras (ej. SAT, COFEPRIS)",
        "justificacion_relevancia": "Establecen las reglas del juego en materia fiscal y sanitaria. El incumplimiento de sus normativas puede detener las operaciones del negocio por completo.",
        "analisis_valor_compartido": {
          "valor_entregado_por_negocio": "Pago de impuestos que contribuyen al gasto público, creación de empleo formal a medida que crece, promoción de productos nacionales.",
          "valor_aportado_al_negocio": "Un marco legal y regulatorio estable que proporciona certeza para operar, protección de la propiedad intelectual (marcas), y acceso a servicios públicos."
        },
        "analisis_conflicto_potencial": {
          "riesgo_causado_por_negocio": "Evasión fiscal, incumplimiento de las normas de etiquetado o de sanidad en el lugar de tostado/empaque.",
          "riesgo_afrontado_por_negocio": "Multas, sanciones, clausura del negocio, cambios en la regulación (ej. nuevos impuestos a alimentos/bebidas) que aumenten los costos operativos y afecten la rentabilidad."
        }
      }
    ]
  }
...
PROMPT_18_COMPETENCIA = """{
  ...
  "instructions": [
    ...
    "3. **Priorización de Amenazas (Instrucción Modificada):** En lugar de seleccionar uno de cada tipo, identifica a los **3 competidores más relevantes** en general, independientemente de su categoría. La selección debe basarse en su impacto potencial en el éxito inicial del negocio. Justifica brevemente por qué cada uno fue elegido.",
    ...
    "   a. **Canales:** ¿Dónde está ubicado y cómo distribuye su oferta?",
    "   b. **Modelo de Ingresos:** ¿Cómo hace dinero? (No solo qué otros productos vende).",
    "   c. **Relación con Clientes:** ¿Cómo o con qué fideliza a sus clientes?",
    "   d. **Soporte Posventa:** ¿Cómo es su servicio de soporte o atención posterior a la compra?",
    "   e. **Nivel de Amenaza (Nueva Instrucción):** Asigna un nivel de amenaza (Alto, Medio, Bajo) y justifica por qué representa ese nivel de riesgo para el nuevo negocio.",
    "5. **Síntesis de Palancas Estratégicas:** Para cada competidor analizado, sintetiza el análisis en dos conclusiones accionables:",
    "   a. **Fortalezas a Respetar:** ¿Qué está haciendo excepcionalmente bien que representa una ventaja competitiva sólida?",
    "   b. **Debilidades a Explotar:** ¿Cuál es la brecha o el punto débil más evidente en su oferta que tu negocio puede capitalizar?",
    "6. **Síntesis Estratégica Global (Nueva Instrucción Crítica):** Después de analizar a todos los competidores, redacta un párrafo final que resuma la oportunidad estratégica. Define la **'Vía Estratégica para la Diferenciación'**, explicando cómo el negocio puede posicionarse de manera única aprovechando las debilidades recurrentes o las brechas desatendidas del mercado."
  ],
  "output_format": {
    "type": "json",
    "description": "El output debe ser un único objeto JSON que contenga el diagnóstico, el mapa competitivo, el análisis profundo de los competidores priorizados y una síntesis estratégica final.",
    "structure": {
        ...
        "analisis_profundo_competidores": [
          {
            ...
            "perfil_competitivo": {
              "canales": "Distribución 100% digital a través de su sitio web y marketing de contenidos. Fuerte posicionamiento SEO.",
...
PROMPT_19_DIFERENCIADOR = """{
  ...
  "output_format": {
    "type": "json",
    "description": "El output debe ser un único objeto JSON que contenga la estrategia de diferenciación completa, culminando con un concepto claro para la Propuesta de Valor y una pregunta de auto-evaluación.",
    "structure": {
        ...
        "manifiesto_de_implementacion": [
          {
            ...
            "plan_de_accion": [
              ...
              {
                "accion": "Donar un 1% de las ventas a un fondo de preservación cultural, comunicándolo de forma transparente.",
...
PROMPT_20_HIPOTESIS = """{
  ...
  "output_format": {
    "type": "json",
    "description": "El output debe ser un único objeto JSON que contenga la lista de las 3 hipótesis de negocio más críticas, formuladas y clasificadas para ser probadas por un MVP.",
    "structure": {
      "hipotesis_de_negocio": [
        {
          "id_hipotesis": "H01",
          "categoria": "Deseabilidad (Valor)",
          "declaracion_hipotesis": "Ej: Creemos que si los 'diseñadores freelance' utilizan la función 'Portal de Cliente', entonces observaremos que al menos un 40% de ellos la usa más de 3 veces en su primera semana porque resuelve su necesidad fundamental de proyectar profesionalismo y reducir la fricción con sus clientes.",
...
PROMPT_21_MVP = """{
  ...
  "output_format": {
    "type": "json",
    "description": "El output debe ser un único objeto JSON que defina de manera inequívoca el Producto Mínimo Viable (MVP) como un experimento enfocado.",
    "structure": {
      "definicion_mvp": {
...
PROMPT_22_LANZAMIENTO = """{
  ...
  "output_format": {
    "type": "json",
    "description": "El output es una estrategia de lanzamiento completa siguiendo una estructura de 8 puntos. El contenido entre [ ] es una instrucción para la IA, no texto a copiar.",
    "structure": {
        ...
        "servicios_profesionales": [
          {
            ...
            "especificaciones_clave_para_cotizar": [
              ...
              "Diseño 100% responsivo (perfecta visualización en móvil, tablet y escritorio).",
...
def _procesar_modulo(user_id: str, db_id: str, sheet_name: str, modulo_name: str,
    ...
    contenido_extenso_json = services.openai_generate_text(prompt_extenso.format(**contexto), response_format="json_object")
